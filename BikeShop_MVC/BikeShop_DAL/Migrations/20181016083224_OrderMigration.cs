        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusOfOrder = table.Column<int>(nullable: false),
                    DateOfExecute = table.Column<DateTime>(nullable: false),
                    TypeOfShipment = table.Column<string>(nullable: true),
                    CostOfShipment = table.Column<decimal>(nullable: false),
                    SummaryCost = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderPositionId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    SelectedQuantity = table.Column<int>(nullable: false),
                    OrderId = table.Column<int>(nullable: false),
